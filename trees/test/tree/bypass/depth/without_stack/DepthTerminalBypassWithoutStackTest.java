 ...
 * terminal - концевой
 */
public class DepthTerminalBypassWithoutStackTest {
    private Node root;
    ...
    @Test
    public void depthTerminalBypassNoStackTest() throws Exception {
        List<Object> sequence = Bypass.depthTerminalBypassNoStack(root);
