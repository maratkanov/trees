...
public class WidthBypassTest {
    ...
    public void widthBypassTest() throws Exception {
        List<Object> sequence = Bypass.widthBypass(root);
        Assert.assertEquals("Обход в ширину не корректен", sequence, correctSequence);
    }
}
